...
class PaymentController extends AbstractController
{
    ...
    #[Route('/fetch-payments', name: 'fetch_payments')]
public function fetchPayments(): Response
{
    // Configurez Stripe avec votre clé d'API
    Stripe::setApiKey('sk_test_51P6dihBtpAjMlV8bUFIDKoPF9JdQFNc4qo6lM44lOrGMi0Iv9SdfAHu3B1J2tPB8wjshqhxiYKiIVCSRzcWTKshp00PEbveIOB');

    // Récupérez la liste des paiements
    $payments = PaymentIntent::all();

    // Retournez les données des paiements à la vue Twig pour affichage
